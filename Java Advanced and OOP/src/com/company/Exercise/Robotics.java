...
public class Robotics {
    public static void main(String[] args) {
        ...
        //съхраняваме името на робота и времето в LinkedHashMap, запазва данните в реда по който сме ги подали
        ...
        while (!products.isEmpty()) {
            ...
            startTimeInSeconds++;
            //трябва да намалим времето за работа на всички роботи, при които има продукт
            ...
            for (Map.Entry<String, Integer> robot : robotsWorkingTime.entrySet()) {//име -> време в което работи
                if (robot.getValue() == 0) {//роботът ни е свободен -> робота започва да обработва продукта
                    // int takenTime =
    ...
    private static String getStartTime(int startTimeInSeconds) {
        //секунди -> "hh:mm:ss"-> hours +":"+ minutes + ":" + seconds
